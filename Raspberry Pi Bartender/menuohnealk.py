...
import Ausfuerungohnealk as Ass
import MFRC522
import signal
...
def homo():
    menupunkt = ['Cocktails','Saft', 'Sets', 'Ausschalten']
...
def mischen():
    ...
    saft = ["O-Saft", "HMA-Saft", "Eistee", "Apfel", "Mango", "Wasser"]
    ...
    oled.cls()
    oled.display()
    draw.text((1, 1),  "Saft Auswahl", font=FreeSans14, fill=1)
    ...
    while w==0:
        ...
        if GPIO.input(18) == False:
            oled.cls()
            oled.display()
            draw.text((1, 1), saft[a], font=FreeSans12, fill=1)
            oled.display()
            while a<6:
                if GPIO.input(16) == False:
                    if a == anzahls-1:
                ...
                if GPIO.input(18) == False:
                    ...
                    oled.cls()
                    draw.text((1,1), wahlsaft, font=FreeSans14, fill=1)
                    ...
                    while True:
                        ...
                        if GPIO.input(18) == False:
                            ...
                            if wahlsaft == 'Mango':
                                ...
                                draw.bitmap((25, 0), Image.open('/home/pi/Desktop/06.12.19/Mango.png'), fill=1)
                            if wahlsaft == 'Wasser':
                                GPIO.output(Pumpe2, GPIO.LOW)
                                draw.bitmap((25, 0), Image.open('/home/pi/Desktop/06.12.19/Wasser.png'), fill=1)
                            if wahlsaft == 'Eistee':
                                GPIO.output(Pumpe3, GPIO.LOW)
                                draw.bitmap((25, 0), Image.open('/home/pi/Desktop/06.12.19/Eistee.png'), fill=1)
                            if wahlsaft == 'Apfel':
                                GPIO.output(Pumpe4, GPIO.LOW)
                                draw.bitmap((25, 0), Image.open('/home/pi/Desktop/06.12.19/Apfel.png'), fill=1)
                            if wahlsaft == 'O-Saft':
                                GPIO.output(Pumpe5, GPIO.LOW)
                                draw.bitmap((25, 0), Image.open('/home/pi/Desktop/lib_oled96test2/Orange.png'), fill=1)
                            if wahlsaft == 'HMA-Saft':
                                GPIO.output(Pumpe6, GPIO.LOW)
                                draw.bitmap((25, 0), Image.open('/home/pi/Desktop/lib_oled96test2/pi_logo.png'), fill=1)
                            oled.display()
                            time.sleep(90*gr)
                            for i in xrange(0,6):
                                GPIO.output(pumpen[i], GPIO.HIGH)
                            oled.cls()
